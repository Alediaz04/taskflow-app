      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={[styles.brandSubtitle, { color: colors.muted }]}>
            Únete y potencia tu productividad
          </Text>
        </View>

        {/* Tarjeta de Formulario Elevada */}
        <View style={[styles.card, { backgroundColor: colors.surface }]}>
          <Text style={[styles.formTitle, { color: colors.ink }]}>Crear cuenta ✨</Text>
          ...
          <View style={styles.inputContainer}>
            <Text style={[styles.inputLabel, { color: colors.ink }]}>Repetir contraseña</Text>
            <View style={[styles.inputWrapper, { backgroundColor: colors.canvas, borderColor: colors.border }]}>
          ...
          <View style={styles.footerLinkRow}>
            <Text style={[styles.footerText, { color: colors.muted }]}>¿Ya tienes una cuenta?</Text>
